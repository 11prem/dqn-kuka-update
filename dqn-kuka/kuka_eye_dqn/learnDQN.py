"""
Baseline DQN code from: https://github.com/mahyaret/kuka_rl/blob/master/kuka_rl.ipynb
"""
import gym
import math
import random
...
env = KukaDiverseObjectEnv(actionRepeat=80, renders=False, isDiscrete=True, maxSteps=30, dv=0.02,
...
if __name__ == "__main__":
  ...
  if options.logfile_name == "":
    LOGFILE = "learnDQN_eye_depth64_fb_" + str(options.framecount) + "_bz_" + str(options.replay_buffer) + ".log"
  ...
  PATH = "policy_dqn_eye_depth64_" + str(options.framecount) + "_bz_" + str(options.replay_buffer) + ".pt"
